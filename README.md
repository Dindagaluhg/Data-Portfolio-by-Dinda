...
- [Investigate Business Hotel using Data Visualization](https://github.com/Dindagaluhg/Business-Hotel-Data-Visualization)
- [Marketing Campaign Analysis](https://github.com/Dindagaluhg/DS-32-FINALPROJECT-KEL5)
- [Predict Customer Personality to Boost Marketing Campaign using Clustering](https://github.com/Dindagaluhg/Predict-Customer-Personality-with-Clustering)
- [Predicting Employee Attrition Using Classification Machine Learning](https://github.com/Dindagaluhg/Predicting-Employee-Attrition-with-Machine-Learning)
- [Forecast Daily Product Sales & Enhance Marketing Campaigns using Clustering](https://github.com/Dindagaluhg/Kalbe-Case-Study)

### SQL:
- [Analyzing eCommerce Business Performance](https://github.com/Dindagaluhg/eCommerce-Analysis-with-SQL)
